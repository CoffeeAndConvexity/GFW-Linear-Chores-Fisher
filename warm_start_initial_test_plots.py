...
plt.plot(data_without_ws['size'], data_without_ws['iteration_EPM_e'], marker='^', label='EPM w/o Warm Start', color='darkorange')
plt.plot(data_with_ws['size'], data_with_ws['iteration_EPM_e'], marker='^', label='EPM with Warm Start', color='brown')
plt.plot(data_without_ws['size'], data_without_ws['iteration_EPM_a1'], marker='^', color='darkorange', linestyle='--')
...
plt.plot(data_without_ws['size'], data_without_ws['runningtime_EPM_e'], marker='^', label='EPM w/o Warm Start', color='darkorange')
plt.plot(data_with_ws['size'], data_with_ws['runningtime_EPM_e'], marker='^', label='EPM with Warm Start', color='brown')
plt.plot(data_without_ws['size'], data_without_ws['runningtime_EPM_a1'], marker='^', color='darkorange', linestyle='--')
...
plt.plot(data_without_ws['size'], data_without_ws['solved_EPM_e'], marker='^', label='EPM w/o Warm Start', color='darkorange')
plt.plot(data_with_ws['size'], data_with_ws['solved_EPM_e'], marker='^', label='EPM with Warm Start', color='brown')
plt.plot(data_without_ws['size'], data_without_ws['solved_EPM_a1'], marker='^', color='darkorange', linestyle='--')
