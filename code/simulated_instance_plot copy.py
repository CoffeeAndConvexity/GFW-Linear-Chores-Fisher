...
def plot_and_save(data, random_generating_method, num_seeds=10, download_fig=False, save_fig_dir='./figures/'):
    ...
    plt.savefig(f"./figures/rt_{random_generating_method}_high_accuracy.png")
    ...
    plt.savefig(f"./figures/ni_{random_generating_method}_high_accuracy.png")
    ...
    plt.savefig(f"./figures/sr_{random_generating_method}_high_accuracy.png")
...
if __name__ == "__main__": 
    ...
    for rgm in rgm_list:
        data = pd.read_csv(f'./data/{rgm}_high_accuracy.csv')
